    ...
    <div className={classes.wrapper}>
      ...
      >
        <g id="Layer_31" data-name="Layer 31">
          <path
            d="m13 62v-9a11 11 0 0 1 11-11h16a11 11 0 0 1 11 11v9z"
            fill="#c7e2fb"
          />
          <path
            d="m20 60c12.22 0 22.72-6.21 27.4-15.12a11 11 0 0 0 -7.4-2.88h-16a11 11 0 0 0 -11 11v6.29a34.91 34.91 0 0 0 7 .71z"
            fill="#ebf7fe"
          />
          <path d="m32 48 5-6h4l-3 9z" fill="#c7e2fb" />
          <path d="m32 48-5-6h-4l3 9z" fill="#c7e2fb" />
          <path
            d="m45 25v4a13 13 0 0 1 -13 13 13 13 0 0 1 -13-13v-4h8.17a10.3 10.3 0 0 0 8.83-5 10.3 10.3 0 0 0 8.83 5z"
            fill="#fddfb1"
          />
          <path d="m27 42 5 6 5-6z" fill="#fddfb1" />
          <path
            d="m32 10a13 13 0 0 0 -13 13v2h8.17a10.3 10.3 0 0 0 8.83-5 10.3 10.3 0 0 0 8.83 5h.17v-2a13 13 0 0 0 -13-13z"
            fill="#c18e5c"
          />
          <path
            d="m45.5 25h-.5v4a12.9 12.9 0 0 1 -.36 3h.86a3.5 3.5 0 0 0 0-7z"
            fill="#fddfb1"
          />
          <path
            d="m19 29v-4h-.5a3.5 3.5 0 0 0 0 7h.86a12.9 12.9 0 0 1 -.36-3z"
            fill="#fddfb1"
          />
